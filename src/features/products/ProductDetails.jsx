...
const ProductDetails = () => {
  ...
  return (
    ...
    <div className="card lg:card-side bg-base-100 shadow-2xl md:py-16 md:px-8 my-8">
      <div className="md:w-[50%]">
        <figure><img className="object-contain" src="https://i.ibb.co/TWgqgvR/download.jpg" alt="Album" /></figure>
      </div>
      <div className="card-body font-serif md:w-[50%] ">
